...
module.exports = class MessageEvent extends BaseEvent {
  ...
  async run(client, message){
    if(message.author.id === '551819471149465631'){
      ...
      let blacklistedwords = ['fuck', 'dick', 'asshole', 'bitch', 'retard', 'bastard', 'cunt', 'ass', 'cum', 'sex', 'sexy', 'https://', 'http://', 'grabify.link', 'discord.gift/', 'iplogger.org', 'pornhub.com', 'hentaihaven.xxx', 'hentaihaven.red']
